...
#Resposavel por criar indentificador unico para os nomes dos arquivos enviados para o servidor
import os
import uuid
    ...
    def galeria():
        ...
        if request.method == 'POST':
            ...
            if not arquivos_permitidos(file.filename):
                flash("Ultilize os tipos de arquivos de imagem permitidos: PNG, JPNG e GIF.", 'danger')
